                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item @@contact__active">
                            <a class="nav-link" href="form_admin.php">Dashboard Admin</a>
                        </li>
                    </ul>
        ...
        <div class="footer-content py-lg-5 py-4 text-center">
            <div class="container">
                <div class="copy-right">
                    <h6>© 2024 Web Programming Blog . Made by <i>(Farah Khairina)</i> with <span class="fa fa-heart" aria-hidden="true"></span><br>Designed by
